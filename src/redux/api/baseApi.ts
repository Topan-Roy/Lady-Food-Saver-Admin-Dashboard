...
export const baseApi = createApi({
    ...
    tagTypes: ["auth", "dashboardStats", "admin-users", "earnings-overview", "Faqs", "payments", "RestaurantProfile", "Banners", "LegalDocuments", "Config", "paymentMethods", "Profile", "Notifications", "Compliance"],
    endpoints: () => ({}),
