  ...
  const [listings, setListings] = useState([
    {
      ...
      description: 'Two slices of our famous spicy pepperoni pizza with extra cheese.',
      price: '$5.99',
      stock: 5,
      status: 'Approved',
      category: 'Pizza',
      ...
      <div className="relative h-48 rounded-2xl overflow-hidden shadow-2xl border border-white/20">
        ...
        <div className="absolute bottom-6 left-8 right-8 flex justify-between items-end">
          ...
          <div className="flex gap-3">
            <Button onClick={() => setIsChatModalOpen(true)} className="bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/20 text-white" size="sm">
              Message Restaurant
            </Button>
          </div>
        </div>
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card className="!bg-[#FF6B35] !border-none !shadow-2xl shadow-orange-200 relative overflow-hidden group">
                ...
                <p className="text-white text-xs font-black uppercase tracking-widest relative z-10">Total Sales</p>
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            {itemsViewMode === 'grid' ? (
              <div className="space-y-10">
                {Object.entries(listings
                  ...
                  .reduce((acc, item) => {
                    ...
                    acc[cat].push(item);
                    return acc;
                  }, {} as Record<string, typeof listings>)).map(([category, items]) => (
                    <div key={category} className="space-y-4">
                      <h4 className="text-lg font-black text-gray-900 border-l-4 border-[#FF6B35] pl-3 uppercase tracking-wider">{category}</h4>
              ...
              <Card noPadding className="overflow-hidden border-none shadow-xl shadow-gray-100/50">
                <Table data={listings.filter(item => categoryFilter === 'all' || item.category === categoryFilter)} columns={[
                  {
                    header: 'Picture',
                    cell: (item) => (
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-1.5">Platform Standard Price</label>
          ...
          <div className="pt-6 flex items-center justify-between gap-4 border-t border-gray-100 mt-6">
            <button onClick={() => setIsEditModalOpen(false)} className="text-gray-400 font-bold hover:text-gray-600 transition-colors text-sm">Discard</button>
            <div className="flex gap-3">
              <Button variant="outline" onClick={() => setIsEditModalOpen(false)} className="px-6 border-gray-200">Cancel</Button>
              <Button variant="primary" onClick={handleSaveEdit} className="px-6 shadow-xl shadow-orange-500/20">Update Item</Button>
            </div>
          </div>
        </div>
      </Modal >
