...
export function Modal({
  ...
  return <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto overflow-x-hidden bg-black/50 backdrop-blur-sm p-4 md:inset-0">
      <div className={`relative w-full ${sizeClasses[size]} max-h-full rounded-xl bg-white shadow-2xl`}>
        {/* Header */}
